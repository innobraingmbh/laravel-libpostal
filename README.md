...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/innobraingmbh/laravel-libpostal.svg?style=flat-square)](https://packagist.org/packages/innobraingmbh/laravel-libpostal)
...
[![Total Downloads](https://img.shields.io/packagist/dt/innobraingmbh/laravel-libpostal.svg?style=flat-square)](https://packagist.org/packages/innobraingmbh/laravel-libpostal)

This is where your description should go. Limit it to a paragraph or two. Consider adding a small example.

## Support us

[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-libpostal.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-libpostal)
...
```php
$libpostal = new Innobrain\Libpostal();
echo $libpostal->echoPhrase('Hello, Innobrain!');
```
